...
if [[ -f "$ROOT_DIR/Assets/Brand/translator-buddy-mark-v2.png" ]]; then
    cp "$ROOT_DIR/Assets/Brand/translator-buddy-mark-v2.png" "$APP_PATH/Contents/Resources/translator-buddy-mark-v2.png"
fi
